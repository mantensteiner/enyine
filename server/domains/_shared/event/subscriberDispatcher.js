...
module.exports = {
	callInternal: function(eventConfig, headers) {
    var defer = q.defer();
    ...
    // HTTP POST
	  var url = eventUrl.get('callInternalSubscribersUrl');
    request.post({
      url:url, 
      body:eventConfig, 
      headers:headers, 
      ...
      if (!error && response.statusCode == 200) {
        ...
        return defer.reject(new Error('Error writing to subscriber service.'));
      }
    });
